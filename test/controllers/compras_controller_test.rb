...
class ComprasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create compra" do
    assert_difference('Compra.count') do
      post compras_url, params: { compra: { carrinho_id: @compra.carrinho_id, cartao_numero: @compra.cartao_numero, pin_cartao: @compra.pin_cartao } }
    end
  ...
  test "should update compra" do
    patch compra_url(@compra), params: { compra: { carrinho_id: @compra.carrinho_id, cartao_numero: @compra.cartao_numero, pin_cartao: @compra.pin_cartao } }
