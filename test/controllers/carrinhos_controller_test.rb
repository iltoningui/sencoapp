...
class CarrinhosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create carrinho" do
    assert_difference('Carrinho.count') do
      post carrinhos_url, params: { carrinho: { default: @carrinho.default, estado: @carrinho.estado, usuario_id: @carrinho.usuario_id } }
    end
  ...
  test "should update carrinho" do
    patch carrinho_url(@carrinho), params: { carrinho: { default: @carrinho.default, estado: @carrinho.estado, usuario_id: @carrinho.usuario_id } }
